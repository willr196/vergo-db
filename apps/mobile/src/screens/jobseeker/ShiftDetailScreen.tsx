      ...
      <ScrollView contentContainerStyle={styles.content} refreshControl={<RefreshControl refreshing={refreshing} onRefresh={() => load(true)} tintColor={colors.primary} />}>
        ...
        {hasAttendance && (
          <View style={styles.section}>
            ...
            {shift.checkedOutAt && <Text style={styles.attendanceHint}>Your hours have been sent to the office. They will confirm them before this shift is paid.</Text>}
          </View>
        )}
