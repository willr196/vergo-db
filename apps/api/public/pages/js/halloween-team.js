/**
 * Halloween — "Build your Halloween team".
 *
...
(function () {
  ...
  var form = document.getElementById('halloweenForm');
  if (!form) return;

  var statusBox = document.getElementById('hwStatus');
  ...
  function buildRequirements() {
    ...
    parts.push('Halloween / special events brief');
  ...
  function buildPayload() {
    ...
    return {
      ...
      // Halloween brief is never mistaken for a standard staffing request.
