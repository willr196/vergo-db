...
updated: 2026-09-05
summary: Who carries the payroll, the holiday pay and the status risk when you book event staff, and what an hour really costs.
draft: false
---

## In short

- Event staff are either on somebody's payroll or genuinely self-employed, and that call decides who carries the cost if it turns out to be wrong.
- Every VERGO worker is PAYE on a casual worker contract, so payroll, holiday pay and employer National Insurance sit with us rather than with you.
- At the 2026/27 floor an hour costs 14.67 pounds while the Employment Allowance covers the National Insurance, and 16.81 pounds once that allowance runs out.
- Direction and equipment are two of the things HMRC's own status tool asks about, and on most catering jobs both of them point the same way.
- Our published rate is 19 pounds an hour per person with a four hour minimum, and there are no booking fees or uniform charges on top.
...
Most write-ups of employer costs quietly assume the [Employment Allowance](https://www.gov.uk/claim-employment-allowance) is always there. It is not. It offsets up to 10,500 pounds of employer National Insurance a year, and it is per business rather than per worker, so a busy year uses it up.
...
HMRC publishes a tool for exactly this. The [Check Employment Status for Tax tool](https://www.gov.uk/guidance/check-employment-status-for-tax) walks through the same questions and gives you a result you can keep. It takes about ten minutes and it is free.
...
### Are VERGO staff employed or self-employed?

They are PAYE, on casual worker contracts. That means we run payroll, pay employer National Insurance, and hold the holiday pay liability. Everyone gets payslips, holiday pay, and a pension where auto-enrolment applies.

### Is holiday pay extra on top of the rate?

No. Rolled-up holiday pay at 12.07 per cent is inside the published rate and does not appear as a separate line. It also does not arrive later as a liability you did not price for.

### Can I just hire event staff as self-employed contractors?

Some genuinely self-employed arrangements exist, but whether yours is one is a question of fact rather than paperwork. HMRC's Check Employment Status for Tax tool is the fastest way to get a defensible answer, and an accountant is the right person to confirm it. We are not able to give you legal or tax advice on your own arrangements.

### What does the 19 pounds an hour actually include?

The person, their holiday pay, employer National Insurance, pension where it applies, and both insurances. There are no booking fees, no uniform charges and no surcharges. Overruns are charged in thirty minute blocks, and there is a 25 per cent uplift after midnight.

### What happens if somebody does not turn up?

We put a replacement on site within one hour, or that shift is not charged. That is the whole remedy and it is written down rather than informal. It is also one of the things that is genuinely harder to promise when you engage people directly.
