...
const PRICING_MATRIX = [
  { clientTier: 'STANDARD', staffTier: 'STANDARD', hourlyRate: '18.50', staffPayRate: '12.50', isBookable: true },
  { clientTier: 'STANDARD', staffTier: 'ELITE', hourlyRate: '28.00', staffPayRate: '18.00', isBookable: false },
  { clientTier: 'PREMIUM', staffTier: 'STANDARD', hourlyRate: '18.50', staffPayRate: '12.50', isBookable: true },
